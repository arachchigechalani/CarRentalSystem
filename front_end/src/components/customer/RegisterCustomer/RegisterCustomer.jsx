        ...
        if (userName.test(this.state.userName)) {
            ...
            if (password.test(this.state.password)) {
                ...
                if (this.state.password === this.state.retypePassword) {
                    ...
                    this.setState({validateState: {retypePasswordColor: 'error', nextButtonUserAccount: true}})
                }
    ...
    validationCustomerDetailsForm = () => {
        ...
        if (email.test(this.state.email)) {
            ...
            if (licence.test(this.state.drivingLicence) || nic.test(this.state.nic)) {
                    ...
                    if (contact.test(this.state.contactNum)) {
                        this.setState({
                            validateState: {
                                contactError: false,
                                contactErrorMessage: '',
                                nextButtonCustomerDetails: false
                            }
                        })
                    } else {
                        this.setState({
                            validateState: {
                                contactError: true,
                                contactErrorMessage: 'Invalid Contact Number',
                                nextButtonCustomerDetail: true
                            }
                        })
                    }
                ...
                this.setState({
                    validateState: {
                        licenseOrNicError: true,
                        licenseOrNicErrorMessage: 'Invalid Licence Num Or Nic Number',
                        nextButtonCustomerDetail: true
                    }
                })
            }
            ...
            this.setState({
                validateState: {
                    emailError: true,
                    emailErrorMessage: 'Invalid Imail',
                    nextButtonCustomerDetail: true
                }
            })
        }
                                    ...
                                    if (this.state.userName != '') {
                                        ...
                                        if (res.code != 'ERR_BAD_REQUEST') {
                                            ...
                                            this.setState({
                                                validateState: {
                                                    userNameError: true,
                                                    userNameMessage: res.response.data.message
                                                }
                                            })
                                        }
                                    } else {
                                ...
                                onClick={async () => {
                                    ...
                                    if (this.state.email != '') {
                                        if (res.code != 'ERR_BAD_REQUEST') {
                                            ...
                                            this.setState({
                                                validateState: {
                                                    emailErrorMessage: 'Email Allready Exist..!',
                                                    emailError: true
                                                }
                                            })
                                        }
