...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   /* @SneakyThrows
    ...
    public ResponseUtil uploadDriverLicenseImage(@RequestParam("param") MultipartFile[] multipartFile , @RequestParam("driverId") String driverId) {
        ...
        String pathDirectory = "D:\\AAD\\Spring Project\\milestone 02 backend\\Easy_Car_Rental_System-Spring-Project-\\EasyCarRental\\src\\main\\resources\\static\\image\\driversLicenceImage";
